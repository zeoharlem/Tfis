...
import com.alphateamone.theophilus.tfis.DialogBox.MyLoadingAlertDialogFrag;
import com.alphateamone.theophilus.tfis.Model.Admin;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void setTypefaceInit(){
        ...
        forgotPassword.setTypeface(mTypefaceBold);
    ...
    private void createSharedPrefAction(Admin admin){
        SharedPreferences sharedPreferences = getSharedPreferences("MyDataTfis", MODE_PRIVATE);
