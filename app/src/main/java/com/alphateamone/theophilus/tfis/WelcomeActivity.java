...
import com.alphateamone.theophilus.tfis.Manager.PreferencesMgr;
...
//                    btnNext.setTextColor(getResources().getColor(R.color.finder_mask));
                    btnNext.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.finder_mask));
